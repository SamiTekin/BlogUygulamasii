...
namespace BlogUygulamasi.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Baslik,Aciklama,,Resim,CategoryId")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Baslik,Aciklama,İcerik,Onay,Anasayfa,Resim,CategoryId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
